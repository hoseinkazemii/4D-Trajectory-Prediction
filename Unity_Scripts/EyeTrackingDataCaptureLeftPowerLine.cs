...
public class EyeTrackingDataCaptureLeftPowerLine : MonoBehaviour
{
    private OVREyeGaze eyeGaze;
    public VREyeTrackingDataManagerPowerLine vrEyeTrackingDataManagerPowerLine; // Assign this in the Inspector
    ...
    void CaptureEyeTrackingData()
    {
        if (eyeGaze != null && OVRManager.eyeFovPremultipliedAlphaModeEnabled)
        {
            ...
            vrEyeTrackingDataManagerPowerLine.UpdateLeftEyeData(gazeDirection, gazePosition);
        }
    }
}
...
// public class EyeTrackingDataCaptureLeft : MonoBehaviour
// {
//     private OVREyeGaze eyeGaze;
...
//             Debug.Log("gazeDirection Left: " + gazeDirection);
