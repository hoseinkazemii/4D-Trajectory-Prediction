...
> *Automation in Construction* (under review, 2025). DOI:&nbsp;`10.XXXX/zenodo.XXXXXXX` <!-- update once assigned -->
...
| **Robust evaluation** | Benchmarks cover spatial generalisation to unseen logistics layouts, varying look-ahead horizons, sensor-noise injection, and lower sampling frequencies. |
