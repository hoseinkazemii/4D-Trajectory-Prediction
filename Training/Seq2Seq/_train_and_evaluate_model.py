...
def _train_and_evaluate_model(X_train_Y_coordinate, X_val_Y_coordinate, X_test_Y_coordinate, y_train_Y_coordinate, y_val_Y_coordinate, y_test_Y_coordinate, \
    ...
    for coordinate in coordinates:
        if coordinate == "Y":
            model_Y.fit(X_train_Y_coordinate, y_train_Y_coordinate, epochs=num_epochs, batch_size=batch_size, validation_data=(X_val_Y_coordinate, y_val_Y_coordinate))
        ...
        if coordinate == "XZ":
            model_XZ.fit(X_train_XZ_coordinate, y_train_XZ_coordinate, epochs=num_epochs, batch_size=batch_size, validation_data=(X_val_XZ_coordinate, y_val_XZ_coordinate))
